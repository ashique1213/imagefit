    ...
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
      <div className="text-center space-y-3">
        ...
        <p className="text-sm text-slate-400 max-w-xl mx-auto">
          Change plain photo background colors to official white, blue, black, or custom colors.
        </p>
      </div>
      ...
      <div className="glass-panel p-8 rounded-3xl border border-slate-800 text-center space-y-4">
        ...
        <h3 className="text-xl font-bold text-white">Background Tool Route Active</h3>
        <p className="text-xs text-slate-400 max-w-md mx-auto">
          Background replacement tool initialized.
        </p>
