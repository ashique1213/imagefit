    ...
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
      <div className="text-center space-y-3">
        <Badge variant="purple" size="md">
          Scanned Signature Recolor & Background
        </Badge>
        ...
        <p className="text-sm text-slate-400 max-w-xl mx-auto">
          Clean scanned paper signatures, convert dark backgrounds to white or transparent, and change ink to official blue or black.
        </p>
      </div>
      ...
      <div className="glass-panel p-8 rounded-3xl border border-slate-800 text-center space-y-4">
        ...
        <h3 className="text-xl font-bold text-white">Signature Tool Route Active</h3>
        <p className="text-xs text-slate-400 max-w-md mx-auto">
          Signature tool route active with initial layout setup.
        </p>
